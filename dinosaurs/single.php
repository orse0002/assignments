...
//->prepare() allows us to have variables in SQL
//We can create placeholders and later fill them w/ some content
...
<head>
	<meta charset="utf-8">
	<title><?php echo $results['dino_name'] ?> &middot; DinoFun</title>
</head>
<body>
